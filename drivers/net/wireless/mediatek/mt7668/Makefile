...
MODULE_NAME := wlan_$(WLAN_CHIP_ID)
...
ccflags-y += -DDRIVER_BUILD_DATE=${date}
...
modules:
	...
	$(MAKE) -C $(KERNEL_SRC) M=$(shell pwd) MODULE_NAME=$(MODULE_NAME) PLATFORM_FLAGS="$(PLATFORM_FLAGS)" modules
